 ...
 * ===========================================================================*/
void can_task_10ms_DCM_DR_rxProcess(void){
	...
	if(!can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_BCM_5].dyn->timedout){
		// Increment timer (up-counter since they are initialized with zero)
		can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_BCM_5].dyn->timeout_timer++;
		if(can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_BCM_5].dyn->timeout_timer \
		>= can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_BCM_5].timeout){
			// Set timeout flag
			CALVOS_CRITICAL_ENTER();
			can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_BCM_5].dyn->timedout=kTrue;
			CALVOS_CRITICAL_EXIT();
			// Call timeout callback if not NULL
			if(can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_BCM_5].timeout_callback != NULL){
				(can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_BCM_5].timeout_callback)();
			}
			// Reset timer
			can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_BCM_5].dyn->timeout_timer = 0u;
		}
	}
	// Only increment timer if message hasn't timed out
	if(!can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_BCM_2].dyn->timedout){
		// Increment timer (up-counter since they are initialized with zero)
		can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_BCM_2].dyn->timeout_timer++;
		if(can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_BCM_2].dyn->timeout_timer \
		>= can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_BCM_2].timeout){
			// Set timeout flag
			CALVOS_CRITICAL_ENTER();
			can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_BCM_2].dyn->timedout=kTrue;
			CALVOS_CRITICAL_EXIT();
			// Call timeout callback if not NULL
			if(can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_BCM_2].timeout_callback != NULL){
				(can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_BCM_2].timeout_callback)();
			}
			// Reset timer
			can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_BCM_2].dyn->timeout_timer = 0u;
		}
	}
	// Only increment timer if message hasn't timed out
	if(!can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_BRAKE_2].dyn->timedout){
		// Increment timer (up-counter since they are initialized with zero)
		can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_BRAKE_2].dyn->timeout_timer++;
		if(can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_BRAKE_2].dyn->timeout_timer \
		>= can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_BRAKE_2].timeout){
			// Set timeout flag
			CALVOS_CRITICAL_ENTER();
			can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_BRAKE_2].dyn->timedout=kTrue;
			CALVOS_CRITICAL_EXIT();
			// Call timeout callback if not NULL
			if(can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_BRAKE_2].timeout_callback != NULL){
				(can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_BRAKE_2].timeout_callback)();
			}
			// Reset timer
			can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_BRAKE_2].dyn->timeout_timer = 0u;
		}
	}
	// Only increment timer if message hasn't timed out
	if(!can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_2].dyn->timedout){
		// Increment timer (up-counter since they are initialized with zero)
		can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_2].dyn->timeout_timer++;
		if(can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_2].dyn->timeout_timer \
		>= can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_2].timeout){
			// Set timeout flag
			CALVOS_CRITICAL_ENTER();
			can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_2].dyn->timedout=kTrue;
			CALVOS_CRITICAL_EXIT();
			// Call timeout callback if not NULL
			if(can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_2].timeout_callback != NULL){
				(can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_2].timeout_callback)();
			}
			// Reset timer
			can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_2].dyn->timeout_timer = 0u;
		}
	}
	// Only increment timer if message hasn't timed out
	if(!can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_4].dyn->timedout){
		// Increment timer (up-counter since they are initialized with zero)
		can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_4].dyn->timeout_timer++;
		if(can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_4].dyn->timeout_timer \
		>= can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_4].timeout){
			// Set timeout flag
			CALVOS_CRITICAL_ENTER();
			can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_4].dyn->timedout=kTrue;
			CALVOS_CRITICAL_EXIT();
			// Call timeout callback if not NULL
			if(can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_4].timeout_callback != NULL){
				(can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_4].timeout_callback)();
			}
			// Reset timer
			can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_4].dyn->timeout_timer = 0u;
		}
	}
	// Only increment timer if message hasn't timed out
	if(!can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_DCU_2].dyn->timedout){
		// Increment timer (up-counter since they are initialized with zero)
		can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_DCU_2].dyn->timeout_timer++;
		if(can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_DCU_2].dyn->timeout_timer \
		>= can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_DCU_2].timeout){
			// Set timeout flag
			CALVOS_CRITICAL_ENTER();
			can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_DCU_2].dyn->timedout=kTrue;
			CALVOS_CRITICAL_EXIT();
			// Call timeout callback if not NULL
			if(can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_DCU_2].timeout_callback != NULL){
				(can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_DCU_2].timeout_callback)();
			}
			// Reset timer
			can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_DCU_2].dyn->timeout_timer = 0u;
		}
	}
