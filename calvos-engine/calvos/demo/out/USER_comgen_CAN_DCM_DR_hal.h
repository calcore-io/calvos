...
/*                           calvOS Project                                   */
/*============================================================================*/
/** \file		USER_comgen_CAN_DCM_DR_hal.h                                  */
 ...
 *     Network version: "2"
 -----------------------------------------------------------------------------*/
#ifndef USER_COMGEN_CAN_DCM_DR_HAL_H
#define USER_COMGEN_CAN_DCM_DR_HAL_H
...
/* CAN HAL functions */
extern CalvosError can_DCM_DR_HALtransmitMsg(const CANtxMsgStaticData* msg_info);
extern void can_DCM_DR_HALconfirmTxMsg(void);
extern void can_DCM_DR_HALreceiveMsg(uint32_t msg_id, uint8_t* data_in, uint8_t data_len);
extern void can_DCM_DR_HALinit(void);

#endif /* USER_COMGEN_CAN_DCM_DR_HAL_H */
