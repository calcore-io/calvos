...
#define kCAN_DCM_PS_sig_avlbl_idx_VehSpeed                (0u)
#define kCAN_DCM_PS_sig_avlbl_idx_BRAKE_2_MC              (1u)
#define kCAN_DCM_PS_sig_avlbl_idx_BRAKE_2_CRC             (2u)
#define kCAN_DCM_PS_sig_avlbl_idx_ShiftLeverPos           (0u)
#define kCAN_DCM_PS_sig_avlbl_idx_TRANSM_2_MC             (1u)
#define kCAN_DCM_PS_sig_avlbl_idx_TRANSM_2_CRC            (2u)
#define kCAN_DCM_PS_sig_avlbl_idx_ShiftLeverEng           (0u)
#define kCAN_DCM_PS_sig_avlbl_idx_TRANSM_4_MC             (1u)
#define kCAN_DCM_PS_sig_avlbl_idx_TRANSM_4_CRC            (2u)
...
const CANrxMsgStaticData can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_nOfRxMsgs] = {\
		{kCAN_msgId_TRANSM_2,	kCAN_DCM_PS_msgTimeout_TRANSM_2,	&can_DCM_PS_TRANSM_2_rx_callback,	&can_DCM_PS_TRANSM_2_timeout_callback,	 \
				&can_DCM_PS_RxDataBuffer[0],	&can_DCM_PS_avlbl_buffer[kCAN_DCM_PS_avlbl_buffer_idx_TRANSM_2],	kCAN_DCM_PS_avlbl_slot_len_TRANSM_2,	 \
				&can_DCM_PS_rxMsgDynamicData[0],	{8u,	kFalse},	NULL,	NULL}, \
		{kCAN_msgId_TRANSM_4,	kCAN_DCM_PS_msgTimeout_TRANSM_4,	&can_DCM_PS_TRANSM_4_rx_callback,	&can_DCM_PS_TRANSM_4_timeout_callback,	 \
				&can_DCM_PS_RxDataBuffer[8],	&can_DCM_PS_avlbl_buffer[kCAN_DCM_PS_avlbl_buffer_idx_TRANSM_4],	kCAN_DCM_PS_avlbl_slot_len_TRANSM_4,	 \
		...
		{kCAN_msgId_BCM_5,	kCAN_DCM_PS_msgTimeout_BCM_5,	&can_DCM_PS_BCM_5_rx_callback,	&can_DCM_PS_BCM_5_timeout_callback,	 \
				&can_DCM_PS_RxDataBuffer[16],	&can_DCM_PS_avlbl_buffer[kCAN_DCM_PS_avlbl_buffer_idx_BCM_5],	kCAN_DCM_PS_avlbl_slot_len_BCM_5,	 \
		...
		{kCAN_msgId_DCU_1,	kCAN_DCM_PS_msgTimeout_DCU_1,	&can_DCM_PS_DCU_1_rx_callback,	&can_DCM_PS_DCU_1_timeout_callback,	 \
				&can_DCM_PS_RxDataBuffer[24],	&can_DCM_PS_avlbl_buffer[kCAN_DCM_PS_avlbl_buffer_idx_DCU_1],	kCAN_DCM_PS_avlbl_slot_len_DCU_1,	 \
				&can_DCM_PS_rxMsgDynamicData[3],	{8u,	kFalse},	&can_DCM_PS_rxMsgStaticData[1],	&can_DCM_PS_rxMsgStaticData[5]}, \
		{kCAN_msgId_BCM_2,	kCAN_DCM_PS_msgTimeout_BCM_2,	&can_DCM_PS_BCM_2_rx_callback,	&can_DCM_PS_BCM_2_timeout_callback,	 \
				&can_DCM_PS_RxDataBuffer[32],	&can_DCM_PS_avlbl_buffer[kCAN_DCM_PS_avlbl_buffer_idx_BCM_2],	kCAN_DCM_PS_avlbl_slot_len_BCM_2,	 \
				&can_DCM_PS_rxMsgDynamicData[4],	{8u,	kFalse},	NULL,	NULL}, \
		{kCAN_msgId_BRAKE_2,	kCAN_DCM_PS_msgTimeout_BRAKE_2,	&can_DCM_PS_BRAKE_2_rx_callback,	&can_DCM_PS_BRAKE_2_timeout_callback,	 \
				&can_DCM_PS_RxDataBuffer[40],	&can_DCM_PS_avlbl_buffer[kCAN_DCM_PS_avlbl_buffer_idx_BRAKE_2],	kCAN_DCM_PS_avlbl_slot_len_BRAKE_2,	 \
				&can_DCM_PS_rxMsgDynamicData[5],	{8u,	kFalse},	&can_DCM_PS_rxMsgStaticData[4],	NULL}};

/* Rx search tree starting index */
#define kCAN_DCM_PS_RxSearchStartIdx		(3u)
 ...
 * ===========================================================================*/
void can_task_10ms_DCM_PS_rxProcess(void){
	...
	if(!can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_BCM_5].dyn->timedout){
		// Increment timer (up-counter since they are initialized with zero)
		can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_BCM_5].dyn->timeout_timer++;
		if(can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_BCM_5].dyn->timeout_timer \
		>= can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_BCM_5].timeout){
			// Set timeout flag
			CALVOS_CRITICAL_ENTER();
			can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_BCM_5].dyn->timedout=kTrue;
			CALVOS_CRITICAL_EXIT();
			// Call timeout callback if not NULL
			if(can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_BCM_5].timeout_callback != NULL){
				(can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_BCM_5].timeout_callback)();
			}
			// Reset timer
			can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_BCM_5].dyn->timeout_timer = 0u;
		}
	}
	// Only increment timer if message hasn't timed out
	if(!can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_BCM_2].dyn->timedout){
		// Increment timer (up-counter since they are initialized with zero)
		can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_BCM_2].dyn->timeout_timer++;
		if(can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_BCM_2].dyn->timeout_timer \
		>= can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_BCM_2].timeout){
			// Set timeout flag
			CALVOS_CRITICAL_ENTER();
			can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_BCM_2].dyn->timedout=kTrue;
			CALVOS_CRITICAL_EXIT();
			// Call timeout callback if not NULL
			if(can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_BCM_2].timeout_callback != NULL){
				(can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_BCM_2].timeout_callback)();
			}
			// Reset timer
			can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_BCM_2].dyn->timeout_timer = 0u;
		}
	}
	// Only increment timer if message hasn't timed out
	if(!can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_BRAKE_2].dyn->timedout){
		// Increment timer (up-counter since they are initialized with zero)
		can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_BRAKE_2].dyn->timeout_timer++;
		if(can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_BRAKE_2].dyn->timeout_timer \
		>= can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_BRAKE_2].timeout){
			// Set timeout flag
			CALVOS_CRITICAL_ENTER();
			can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_BRAKE_2].dyn->timedout=kTrue;
			CALVOS_CRITICAL_EXIT();
			// Call timeout callback if not NULL
			if(can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_BRAKE_2].timeout_callback != NULL){
				(can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_BRAKE_2].timeout_callback)();
			}
			// Reset timer
			can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_BRAKE_2].dyn->timeout_timer = 0u;
		}
	}
	// Only increment timer if message hasn't timed out
	if(!can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_TRANSM_2].dyn->timedout){
		// Increment timer (up-counter since they are initialized with zero)
		can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_TRANSM_2].dyn->timeout_timer++;
		if(can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_TRANSM_2].dyn->timeout_timer \
		>= can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_TRANSM_2].timeout){
			// Set timeout flag
			CALVOS_CRITICAL_ENTER();
			can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_TRANSM_2].dyn->timedout=kTrue;
			CALVOS_CRITICAL_EXIT();
			// Call timeout callback if not NULL
			if(can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_TRANSM_2].timeout_callback != NULL){
				(can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_TRANSM_2].timeout_callback)();
			}
			// Reset timer
			can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_TRANSM_2].dyn->timeout_timer = 0u;
		}
	}
	// Only increment timer if message hasn't timed out
	if(!can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_TRANSM_4].dyn->timedout){
		// Increment timer (up-counter since they are initialized with zero)
		can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_TRANSM_4].dyn->timeout_timer++;
		if(can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_TRANSM_4].dyn->timeout_timer \
		>= can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_TRANSM_4].timeout){
			// Set timeout flag
			CALVOS_CRITICAL_ENTER();
			can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_TRANSM_4].dyn->timedout=kTrue;
			CALVOS_CRITICAL_EXIT();
			// Call timeout callback if not NULL
			if(can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_TRANSM_4].timeout_callback != NULL){
				(can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_TRANSM_4].timeout_callback)();
			}
			// Reset timer
			can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_TRANSM_4].dyn->timeout_timer = 0u;
		}
	}
	// Only increment timer if message hasn't timed out
	if(!can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_DCU_1].dyn->timedout){
		// Increment timer (up-counter since they are initialized with zero)
		can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_DCU_1].dyn->timeout_timer++;
		if(can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_DCU_1].dyn->timeout_timer \
		>= can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_DCU_1].timeout){
			// Set timeout flag
			CALVOS_CRITICAL_ENTER();
			can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_DCU_1].dyn->timedout=kTrue;
			CALVOS_CRITICAL_EXIT();
			// Call timeout callback if not NULL
			if(can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_DCU_1].timeout_callback != NULL){
				(can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_DCU_1].timeout_callback)();
			}
			// Reset timer
			can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_DCU_1].dyn->timeout_timer = 0u;
		}
	}
...
void can_DCM_PS_coreInit(void){
	...
	can_DCM_PS_transmittingMsg = NULL;
