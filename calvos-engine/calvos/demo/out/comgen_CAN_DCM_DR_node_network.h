...
#define kCAN_DCM_DR_msg_dir_TRANSM_2    (kDirRX)
#define kCAN_DCM_DR_msg_dir_TRANSM_4    (kDirRX)
...
#define kCAN_DCM_DR_avlbl_buffer_idx_TRANSM_2    (3u)
#define kCAN_DCM_DR_avlbl_buffer_idx_TRANSM_4    (4u)
#define kCAN_DCM_DR_avlbl_buffer_idx_DCU_2       (5u)
...
#define kCAN_DCM_DR_avlbl_slot_len_TRANSM_2    (1u)
#define kCAN_DCM_DR_avlbl_slot_len_TRANSM_4    (1u)
...
typedef enum{
	kCAN_DCM_DR_rxMsgIdx_TRANSM_2=0,
	kCAN_DCM_DR_rxMsgIdx_TRANSM_4,
	kCAN_DCM_DR_rxMsgIdx_BCM_5,
...
/*** Message Level macros ***/
/* Get message data from unified buffer */
#define CAN_DCM_DR_get_msg_TRANSM_2(data_struct)		CALVOS_CRITICAL_ENTER(); \
															memcpy(data_struct.all, \
															can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_2].data, \
															can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_2].fields.len); \
															CALVOS_CRITICAL_EXIT();

/* Get message available flags */
#define CAN_DCM_DR_get_msg_avlbl_flags_TRANSM_2()		(can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_2].dyn->available)

/* Clear message available flags */
#define CAN_DCM_DR_clr_msg_avlbl_flags_TRANSM_2()		can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_2].dyn->available.all = 0u;

/* Clear all available flags (message and signals) */
#define CAN_DCM_DR_clr_all_avlbl_flags_TRANSM_2()		can_clearAllAvlblFlags(&can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_2])

/*** Signal Level macros ***/
/* Macros for direct reading of signal "ShiftLeverPos". */
#define CAN_DCM_DR_get_direct_ShiftLeverPos()                  (CAN_extract_ShiftLeverPos(can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_2].data))

/* Macros for available flags handling of signal "ShiftLeverPos". */
#define CAN_DCM_DR_get_avlbl_ShiftLeverPos()                   (can_DCM_DR_avlbl_buffer[3] & 0x01u)
#define CAN_DCM_DR_clr_avlbl_ShiftLeverPos()                   (can_DCM_DR_avlbl_buffer[3] = can_DCM_DR_avlbl_buffer[3] & 0xfeu)

/* Macros for direct reading of signal "TRANSM_2_MC". */
#define CAN_DCM_DR_get_direct_TRANSM_2_MC()                  (CAN_extract_TRANSM_2_MC(can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_2].data))

/* Macros for available flags handling of signal "TRANSM_2_MC". */
#define CAN_DCM_DR_get_avlbl_TRANSM_2_MC()                   ((can_DCM_DR_avlbl_buffer[3] >> 0x01u) & 0x01u)
#define CAN_DCM_DR_clr_avlbl_TRANSM_2_MC()                   (can_DCM_DR_avlbl_buffer[3] = can_DCM_DR_avlbl_buffer[3] & 0xfdu)

/* Macros for direct reading of signal "TRANSM_2_CRC". */
#define CAN_DCM_DR_get_direct_TRANSM_2_CRC()                  (CAN_extract_TRANSM_2_CRC(can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_2].data))

/* Macros for available flags handling of signal "TRANSM_2_CRC". */
#define CAN_DCM_DR_get_avlbl_TRANSM_2_CRC()                   ((can_DCM_DR_avlbl_buffer[3] >> 0x02u) & 0x01u)
#define CAN_DCM_DR_clr_avlbl_TRANSM_2_CRC()                   (can_DCM_DR_avlbl_buffer[3] = can_DCM_DR_avlbl_buffer[3] & 0xfbu)

/* ----------- Macros for Rx message "TRANSM_4" ----------- */
/*** Message Level macros ***/
/* Get message data from unified buffer */
#define CAN_DCM_DR_get_msg_TRANSM_4(data_struct)		CALVOS_CRITICAL_ENTER(); \
															memcpy(data_struct.all, \
															can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_4].data, \
															can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_4].fields.len); \
															CALVOS_CRITICAL_EXIT();

/* Get message available flags */
#define CAN_DCM_DR_get_msg_avlbl_flags_TRANSM_4()		(can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_4].dyn->available)

/* Clear message available flags */
#define CAN_DCM_DR_clr_msg_avlbl_flags_TRANSM_4()		can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_4].dyn->available.all = 0u;

/* Clear all available flags (message and signals) */
#define CAN_DCM_DR_clr_all_avlbl_flags_TRANSM_4()		can_clearAllAvlblFlags(&can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_4])

/*** Signal Level macros ***/
/* Macros for direct reading of signal "ShiftLeverEng". */
#define CAN_DCM_DR_get_direct_ShiftLeverEng()                  (CAN_extract_ShiftLeverEng(can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_4].data))

/* Macros for available flags handling of signal "ShiftLeverEng". */
#define CAN_DCM_DR_get_avlbl_ShiftLeverEng()                   (can_DCM_DR_avlbl_buffer[4] & 0x01u)
#define CAN_DCM_DR_clr_avlbl_ShiftLeverEng()                   (can_DCM_DR_avlbl_buffer[4] = can_DCM_DR_avlbl_buffer[4] & 0xfeu)

/* Macros for direct reading of signal "TRANSM_4_MC". */
#define CAN_DCM_DR_get_direct_TRANSM_4_MC()                  (CAN_extract_TRANSM_4_MC(can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_4].data))

/* Macros for available flags handling of signal "TRANSM_4_MC". */
#define CAN_DCM_DR_get_avlbl_TRANSM_4_MC()                   ((can_DCM_DR_avlbl_buffer[4] >> 0x01u) & 0x01u)
#define CAN_DCM_DR_clr_avlbl_TRANSM_4_MC()                   (can_DCM_DR_avlbl_buffer[4] = can_DCM_DR_avlbl_buffer[4] & 0xfdu)

/* Macros for direct reading of signal "TRANSM_4_CRC". */
#define CAN_DCM_DR_get_direct_TRANSM_4_CRC()                  (CAN_extract_TRANSM_4_CRC(can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_rxMsgIdx_TRANSM_4].data))

/* Macros for available flags handling of signal "TRANSM_4_CRC". */
#define CAN_DCM_DR_get_avlbl_TRANSM_4_CRC()                   ((can_DCM_DR_avlbl_buffer[4] >> 0x02u) & 0x01u)
#define CAN_DCM_DR_clr_avlbl_TRANSM_4_CRC()                   (can_DCM_DR_avlbl_buffer[4] = can_DCM_DR_avlbl_buffer[4] & 0xfbu)
...
#define CAN_DCM_DR_get_avlbl_DCU_2_WindowPos()                   (can_DCM_DR_avlbl_buffer[5] & 0x01u)
#define CAN_DCM_DR_clr_avlbl_DCU_2_WindowPos()                   (can_DCM_DR_avlbl_buffer[5] = can_DCM_DR_avlbl_buffer[5] & 0xfeu)
...
#define CAN_DCM_DR_get_avlbl_DCU_2_LockingReq()                   ((can_DCM_DR_avlbl_buffer[5] >> 0x01u) & 0x01u)
#define CAN_DCM_DR_clr_avlbl_DCU_2_LockingReq()                   (can_DCM_DR_avlbl_buffer[5] = can_DCM_DR_avlbl_buffer[5] & 0xfdu)
...
#define CAN_DCM_DR_get_avlbl_DCU_2_WindowOp()                   ((can_DCM_DR_avlbl_buffer[5] >> 0x02u) & 0x01u)
#define CAN_DCM_DR_clr_avlbl_DCU_2_WindowOp()                   (can_DCM_DR_avlbl_buffer[5] = can_DCM_DR_avlbl_buffer[5] & 0xfbu)
...
#define CAN_DCM_DR_get_avlbl_DCU_2_DoorLockSts()                   ((can_DCM_DR_avlbl_buffer[5] >> 0x03u) & 0x01u)
#define CAN_DCM_DR_clr_avlbl_DCU_2_DoorLockSts()                   (can_DCM_DR_avlbl_buffer[5] = can_DCM_DR_avlbl_buffer[5] & 0xf7u)
...
#define CAN_DCM_DR_get_avlbl_DCU_2_MC()                   ((can_DCM_DR_avlbl_buffer[5] >> 0x04u) & 0x01u)
#define CAN_DCM_DR_clr_avlbl_DCU_2_MC()                   (can_DCM_DR_avlbl_buffer[5] = can_DCM_DR_avlbl_buffer[5] & 0xefu)
...
#define CAN_DCM_DR_get_avlbl_DCU_2_CRC()                   ((can_DCM_DR_avlbl_buffer[5] >> 0x05u) & 0x01u)
#define CAN_DCM_DR_clr_avlbl_DCU_2_CRC()                   (can_DCM_DR_avlbl_buffer[5] = can_DCM_DR_avlbl_buffer[5] & 0xdfu)
